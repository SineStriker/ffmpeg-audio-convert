...
//                             codec_params->sample_rate, 0, NULL) ||
//         swr_init(swr_ctx) < 0) {
...
//                 av_channel_layout_copy(&resampled_frame->ch_layout,
...
//                     av_packet_rescale_ts(&pkt, output_codec_ctx->time_base,
//                     out_stream->time_base); pkt.stream_index = out_stream->index; if
//                     (av_interleaved_write_frame(output_ctx, &pkt) < 0) {
